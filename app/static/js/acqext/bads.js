...
var bads = {
  ...
  reverse: Array(10).fill(false), // see WHO5 scoring instructions
  instructions: `Please read each statement carefully and then circle the number which best describes how
  much the statement was true for you <b>DURING THE PAST WEEK, INCLUDING
  TODAY</b>.`,
  survey_width: 950,
  item_width: 50,
  scale_repeat: 11,
  ...
  infrequency_items: [6],
  data:{survey: "bads", infreq: none_endorse[4], infreq_location: "Q07"}
}