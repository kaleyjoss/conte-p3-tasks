...
var ami = {
  ...
  reverse: Array(19).fill(true), // see AMI scoring instructions; "each item is negatively scored"
  instructions: `Below are a number of statements. Each statement asks you to think about your life over the <b>last 2 weeks</b>.
  ...
  infrequency_items: [6],
  data:{survey:"ami", infreq: none_endorse[3], infreq_location: "Q15"}  
}