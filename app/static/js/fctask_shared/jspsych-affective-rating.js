...
jsPsych.plugins["affective-rating"] = (function() {
  ...
  plugin.info = {
    ...
    parameters: {
      ...
      prompt: {
        type: jsPsych.plugins.parameterType.STRING, // BOOL, STRING, INT, FLOAT, FUNCTION, KEY, SELECT, HTML_STRING, IMAGE, AUDIO, VIDEO, OBJECT, COMPLEX
        default: "How do you feel when you look at each picture?",
  ...
  plugin.trial = function(display_element, trial) {
    ...
    <div style="display:flex; flex-direction: column">  
	  ...
	  <p style="font-size:16px">Calm</p>
          <div class="slidecontainer">
            <input type="range" min="0" max="100" value="${startValOne}" step= "1" class="slider" id="slider-csminus">
              <p style="font-size:16px">Neutral</p>
          </div>
          <p style="font-size:16px">Alert</p>
        </div>
      </div>
    </div>
    `;
    ...
    let timeoutHTML = `
      <h3 id="timeoutWarning" style="font-size: 20px; padding-bottom: 5px; color: orange; visibility:hidden">!!! Please respond to each scale to proceed !!!</h3></h3>
    `;
    ...
    // display slider initial value
    //document.getElementById("rangeValueOne").innerHTML= startValOne
    //document.getElementById("rangeValueTwo").innerHTML= startValTwo
    ...
    function endTrial() {
      ...
      if (trial.imageCSplus !== null) {
        var trial_data = {
          sequence: sequence,
          csPlusAffectRating: document.getElementById("slider-csplus").value,
          csMinusAffectRating: sliderCSminus.value,
          totalTime: totalTime,

          // slider specific responses
          csPlusAffectResponses: csPlusResponses,
          csPlusAffectRTs: csPlusRTs,
          csMinusAffectResponses: csMinusResponses,
          csMinusAffectRTs: csMinusRTs,
        ...
        var trial_data = {
          sequence: sequence,
          csAffectRating: sliderCSminus.value,
          totalTime: totalTime,

          // slider specific responses
          csAffectResponses: csMinusResponses,
          csAffectRTs: csMinusRTs,
