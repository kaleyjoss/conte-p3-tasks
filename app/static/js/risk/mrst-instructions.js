...
instructions_03 = {
  ...
  pages: [
    ...
    {
      prompt: "<p><b>Hint #2:</b> The luckiness of a card is the same regardless of where it appears.</p><p>Its luck does not depend on if it is on the left or right side of the screen.</p>"
    },
    {
...
var quiz = {
  ...
  prompts: [
    ...
    "<b><i>True</i> or <i>False</i>:</b>&nbsp;&nbsp;I will earn points for the option I <u>did not</u> choose.",
    "<b><i>True</i> or <i>False</i>:</b>&nbsp;&nbsp;A card's luckiness is different when it's on the left or the right of the screen.",
