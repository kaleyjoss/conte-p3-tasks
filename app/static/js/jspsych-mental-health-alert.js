...
jsPsych.plugins["mental-health-alert"] = (function() {
  ...
  plugin.info = {
    ...
    parameters: {
      ...
      version: {
        type: jsPsych.plugins.parameterType.STRING,
        pretty_name: 'mh resource version',
        default:  'questionnaire',
        description: 'version for questionnaire includes sentence regarding confidentiality of response'
      }
  ...
  plugin.trial = function(display_element, trial) {
    ...
    // Add paragraph 1.
    html += '<h3>Mental Health Resources</h3>'
    html += '<hr>';

    if (trial.version == 'questionnaire'){
      html += '<p>Thank you for your honesty. As a reminder, your responses to the questionnaires will remain strictly anonymous. Your identity is not known to the experimenters.</p>';
    }

    html += '<p>Please note that experimenters at the Niv Lab are not in a position to diagnose any disorders or offer medical advice.</p>';
