...
jsPsych.plugins['survey-multi-choice'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html += ".jspsych-survey-multi-choice-question { margin-top: 2em; margin-bottom: 2em; text-align: center;}"+
      ...
      ".jspsych-survey-multi-choice-horizontal .jspsych-survey-multi-choice-text {  text-align: left; font-size:16px}"+
      ".jspsych-survey-multi-choice-option { line-height: 2; text-align: left; font-size: 12px}"+
      ".jspsych-survey-multi-choice-horizontal .jspsych-survey-multi-choice-option {  display: inline-block;  margin-left: 0.7em;  margin-right: 0.7em;  vertical-align: top;}"+
