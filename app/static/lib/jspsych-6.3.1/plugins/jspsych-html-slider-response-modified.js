...
jsPsych.plugins['html-slider-response-modified'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html += '">';
    html += '<input type="range" class="jspsych-slider" style="width: '+trial.slider_width+'px;" value="'+trial.slider_start+'" min="'+trial.min+'" max="'+trial.max+'" step="'+trial.step+'" id="jspsych-html-slider-response-response"></input>';
    html += '<div>'
