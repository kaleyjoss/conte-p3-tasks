...
jsPsych.plugins['html-slider-response-effort'] = (function() {

  var plugin = {};

  plugin.info = {
    name: 'html-slider-response-effort',
    description: '',
    parameters: {
      stimulus: {
      ...
      trial_name: {
        ...
        default: 'html-slider-response-effort',
        description: 'Saves as the name of the item in data.'
      }
    }
  }
  ...
  plugin.trial = function(display_element, trial) {
    ...
    // html += '<div>'
    html +=  '<input type="range" min="1" max="100" value="50" class="slider" id="jspsych-html-slider-response-response"></input>';
    html += '<div>';
