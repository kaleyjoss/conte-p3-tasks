...
jsPsych.plugins['survey-debrief'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html += '<p>Please answer the questions below. <font color="#c87606">Your answers will not affect your payment or bonus, but they will help us to improve the task and better answer our scientific question.</font></p>'
    html += '</div>';
    ...
    html += '<div class="survey-debrief-row">';
    html += '<div class="survey-debrief-prompt"><label for="fun">How interesting did you find the task?</label></div>';
    html += '<div class="survey-debrief-response">';
    html += '<label><input type="radio" name="fun" value="5" required>Very interesting</label><br>';
    html += '<label><input type="radio" name="fun" value="4" required>Somewhat interesting</label><br>';
    html += '<label><input type="radio" name="fun" value="3" required>Neither interesting nor boring</label><br>';
    ...
    // Item 4: Goal of task
    html += '<div class="survey-debrief-row">';
    html += '<div class="survey-debrief-prompt"><label for="goal">What do you think this task was about?</label></div>';
    ...
    html += '<div class="survey-debrief-row">';
    html += '<div class="survey-debrief-prompt"><label for="strategy">Did you use any strategies during the task? Did you use different strategies in part one versus part two?</label></div>';
    html += '<div class="survey-debrief-response"><input type="text" name="strategy"></div>';
    html += '</div>';

    // Item 6: Decision making
    html += '<div class="survey-debrief-row">';
    html += '<div class="survey-debrief-prompt"><label for="decision">How did you decide which balloon option you would choose?</label></div>';
    html += '<div class="survey-debrief-response"><input type="text" name="decision"></div>';
    html += '</div>';
    ...
    // Item: similar settings
    html += '<div class="survey-debrief-row">';
    html += '<div class="survey-debrief-prompt"><label for="setting">Were there any differences in yourself or the setting in which you took both experiments? For example, was it the same time of day or the same computer?</label></div>';
    html += '<div class="survey-debrief-response"><input type="text" name="setting"></div>';
    html += '</div>';
    ...
    // Item 9: Language
    html += '<div class="survey-debrief-row">';
    html += '<div class="survey-debrief-prompt"><label for="language">Are you a fluent in English?</label></div>';
    html += '<div class="survey-debrief-response">';
